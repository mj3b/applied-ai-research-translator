...
def main():
    ...
    # Locked, static t_c02 definitions (do not let runtime change these)
    decision_id = "t_c02"
    pack_id = "t_c02"
    ...
    decision_summary = {
        ...
        "section_3_claims_evaluated": [
            {
                "claim_id": "c02-01",
                "claim_statement": "LLM-assisted classification can reduce time-to-evidence without degrading decision quality when HITL controls are enforced.",
